...
OUTPUT_DIR = "/home/mshahidul/llm_safety/sc_project/outputs/evaluations/finetuned/gemma-3-4b-it"
...
print(f"\nTraining done. Metrics: {train_metrics}")
...
# Re-format test dataset for inference (user prompt only)
test_prompts = []
test_expected = []
