...
| ----------------------------- | -------- | --------- | ------ | ----- | ------- | ------ |
| `google/gemma-3-4b-it`        | 45.53%   | 0.00%     | 0.00%  | 0.00% | 50.00%  | 54.47% |
| `Qwen/Qwen3-4B-Instruct-2507` | 45.53%   | 0.00%     | 0.00%  | 0.00% | 50.00%  | 54.47% |
...
| Model                         | Accuracy | Precision | Recall | F1     | AUC-ROC | AUC-PR |
| ----------------------------- | -------- | --------- | ------ | ------ | ------- | ------ |
| `google/gemma-3-4b-it`        | 52.44%   | 56.69%    | 53.73% | 55.17% | 52.31%  | 55.67% |
| `Qwen/Qwen3-4B-Instruct-2507` | 49.19%   | 53.19%    | 55.97% | 54.55% | 48.52%  | 53.76% |


After the decoding fix, few-shot prompting recovered to roughly `0.55` F1 for both models. Gemma is slightly stronger on accuracy, precision, F1, AUC-ROC, and AUC-PR, while Qwen is slightly stronger on recall.
...
| Model                         | Accuracy | Precision | Recall | F1     | AUC-ROC | AUC-PR |
| ----------------------------- | -------- | --------- | ------ | ------ | ------- | ------ |
| `google/gemma-3-4b-it`        | 56.10%   | 58.40%    | 67.20% | 62.50% | 55.00%  | N/A    |
| `Qwen/Qwen3-4B-Instruct-2507` | 53.66%   | 56.17%    | 67.91% | 61.49% | 52.26%  | 55.63% |


Chain-of-thought is the strongest prompting strategy in the saved outputs. Both models reach recall near `67%`, and Gemma has a small overall edge on accuracy, precision, F1, and AUC-ROC.
...
| Model                         | Method                    | Test Samples | Accuracy | Precision | Recall  | F1     | AUC-ROC | AUC-PR | Train Loss | Train Runtime |
| ----------------------------- | ------------------------- | ------------ | -------- | --------- | ------- | ------ | ------- | ------ | ---------- | ------------- |
| `unsloth/gemma-3-4b-it`       | `LoRA_finetuning_unsloth` | 246          | 95.53%   | 93.01%    | 99.25%  | 96.03% | 95.16%  | 92.72% | 0.3894     | 433.97s       |
| `Qwen/Qwen3-4B-Instruct-2507` | `LoRA_finetuning_unsloth` | 246          | 82.11%   | 75.28%    | 100.00% | 85.90% | 80.36%  | 75.28% | 0.3871     | 329.11s       |
